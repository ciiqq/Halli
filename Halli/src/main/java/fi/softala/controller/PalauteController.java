...
import org.springframework.web.servlet.ModelAndView;
	...
	public class PalauteController {
		...
		public ModelAndView palautelista(HttpServletRequest request,
		...
		@RequestMapping(value = "palautteet2", method = RequestMethod.GET)
		...
		HttpServletResponse response) throws Exception {
			...
			model.addAttribute("palautteet2", dao.haeIdlla());
			return new ModelAndView("palaute2", model);
