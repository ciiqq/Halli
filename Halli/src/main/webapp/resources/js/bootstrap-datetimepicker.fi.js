...
(function (factory) {
    ...
    var numbers_past = 'nolla yksi kaksi kolme nelj‰ viisi kuusi seitsem‰n kahdeksan yhdeks‰n'.split(' '),
        numbers_future = ['nolla', 'yhden', 'kahden', 'kolmen', 'nelj‰n', 'viiden', 'kuuden',
