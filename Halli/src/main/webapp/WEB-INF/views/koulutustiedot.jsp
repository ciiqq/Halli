		...
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					...
					<p>Koulutuksen tiedot menee tähän. Also, MVC-malli</p>
					...
					<div class="pull-right">
						...
						<a href="<%=request.getContextPath()%>/opettaja/koulutukset/julkaisemattomat/muokkaa" class="btn btn-default">Muokkaa koulutusta</a>
						<a href="<%=request.getContextPath()%>/opettaja/koulutukset/julkaisemattomat/" class="btn btn-primary">Julkaise koulutus</a>
					</div>
					</div>
				</div>
			</div>
