		...
		<div class="row">
			<div class="col-md-3">
				<ul class="nav nav-pills nav-stacked">
					<li class="active"><a href="<%=request.getContextPath()%>/opettaja/koulutukset/julkaisemattomat">Julkaisemattomat koulutukset</a></li>
					<li><a href="<%=request.getContextPath()%>/opettaja/koulutukset/julkaistut">Julkaistut koulutukset</a></li>
				</ul>
			</div>
			<div class="col-md-9">
					...
					<div class="panel-body">
						<table style="" class="table table-striped">
							...
							<c:forEach items="${koulutukset}" var="k">
								<tr>
									<td><c:out value="${k.suomiPvm}" /> <c:out value="${k.suomiKloAlku}" />-<c:out value="${k.suomiKloLoppu}" /></td>
									<td><c:out value="${k.aihe}" /></td>
									<td><a href="<%=request.getContextPath()%>/opettaja/koulutukset/julkaisemattomat/koulutustiedot" class="btn btn-primary btn-xs" >Koulutuksen tiedot</a></td>
								</tr>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger">Poista koulutus</button>
        <button type="button" class="btn btn-primary">Julkaise koulutus</button>
        <button type="button" class="btn btn-default">Tallenna muutokset</button>
      </div>
    </div>
  </div>
</div>
